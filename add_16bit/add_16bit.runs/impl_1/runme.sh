...
HD_PWD='/home/mateus/ufc/FPGA_Projets/FPGA_Projets/add_16bit/add_16bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log add_16bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source add_16bit.tcl -notrace
