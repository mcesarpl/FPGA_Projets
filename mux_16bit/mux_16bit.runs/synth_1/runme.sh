...
HD_PWD='/home/mateus/mux_16bit/mux_16bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_16bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_16bit.tcl
