...
HD_PWD='C:/Users/Meu computador/Desktop/7 semestre/FPGA/Projetos/FPGA_Projets/mult_8bit/mult_8bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_8bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mult_8bit.tcl -notrace
